...
## 基础篇
### Nginx 的中间件架构
![](Nginx%20%E5%AD%A6%E4%B9%A0/0584FBCF-E253-4A1E-AB1E-D075D88B9560.png)
...
![](Nginx%20%E5%AD%A6%E4%B9%A0/7B23AA85-E1DE-45AD-B815-957E3A0A77D7.png)
...
`/etc/nginx/mime.types`设置http协议的 Content-Type 与扩展名对应关系 
...
安装编译参数
![](Nginx%20%E5%AD%A6%E4%B9%A0/9055EAE7-4135-4286-8B3C-4CA869046D12.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/70FDE2BA-80E3-4ED5-ACE8-DEAC6CC24639.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/00ADA2DB-669D-42EA-A3E3-7A4F1978396E.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/52B79A4B-255E-4969-AA8E-069B7F1ED4B8.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/274C85E3-9DB3-4DFF-A676-ADCB64FCE98D.png)

/etc/nginx/nginx.conf (默认配置):
![](Nginx%20%E5%AD%A6%E4%B9%A0/469B17C8-5940-4E46-A5B2-703420C7A436.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/C2341ABD-190E-4AD2-9893-B157645AE8F4.png)

![](Nginx%20%E5%AD%A6%E4%B9%A0/6D160A7A-1CD1-4BB3-8C7E-EBFC4A683064.png)
Tip：可以在 error_page 配置中配置更多的错误类型，例如 404 共同使用同一个错误页面，错误页面的路径配置在 location 中定义  

![](Nginx%20%E5%AD%A6%E4%B9%A0/CA9F55D1-8803-4C15-B6E2-3BF27514B6BD.png)
一个http有多个 server 一个server 有多个location

### HTTP 请求
![](Nginx%20%E5%AD%A6%E4%B9%A0/EEA78E99-8227-4E06-BC05-64AE9D059687.png)
...
### Nginx 日志类型
默认的日志文件和目录位置
![](Nginx%20%E5%AD%A6%E4%B9%A0/A17C42BA-161D-443D-AE01-2BA7A9632FF4.png)
上面的位置也可以根据 /etc/nginx/nginx.conf 文件中定义的路径来查找：
![](Nginx%20%E5%AD%A6%E4%B9%A0/E6B38B32-F70C-46C4-A813-7EE8735513A1.png)
...
![](Nginx%20%E5%AD%A6%E4%B9%A0/CBC8A1EC-818E-4C43-BB25-69E7EEC00FBD.png)
...
典型模块
![](Nginx%20%E5%AD%A6%E4%B9%A0/EF5713BF-85E4-4A2E-97A2-DCE29731E417.png)
...
![](Nginx%20%E5%AD%A6%E4%B9%A0/A50ABB17-048F-4D4F-A6BC-20B00216E191.png)
```
# 模块的语法项目
...
![](Nginx%20%E5%AD%A6%E4%B9%A0/4B08455B-C59F-43AB-946A-98924D83700B.png)
```
# 模块的典型语法
...
![](Nginx%20%E5%AD%A6%E4%B9%A0/3A796EF2-B83D-4CE7-88AA-33214C40E464.png)
HTTP 协议建立在 TCP 协议之上，先要进行 TCP 的三次握手。
![](Nginx%20%E5%AD%A6%E4%B9%A0/25D45A58-7BFE-40CD-8A9D-7D505B7FA95E.png)
```
# 连接限制
...
```
eg：
![](Nginx%20%E5%AD%A6%E4%B9%A0/E6A1386D-74B8-4F7D-A2F3-722C68BCA483.png)
...
```
eg:
![](Nginx%20%E5%AD%A6%E4%B9%A0/D1E76EFA-3DBB-47A7-8E3B-0E6AAFC1B317.png)
原理（remote_addr 变量是请求的ip）：
![](Nginx%20%E5%AD%A6%E4%B9%A0/6EEA5700-9800-40AB-B4B9-6DA98BFC3A50.png)
（只能通过 $remote_addr 控制信任，不是很准确容易产生问题或者绕过验证）
另一种方案：
![](Nginx%20%E5%AD%A6%E4%B9%A0/5E40D9B0-DC15-4AEA-B4D6-402C4E8C5CA8.png)
```
